...
/**
 * Classe che rappresenta il pannello per la gestione delle operazioni di un gestore.
 * Questo pannello include opzioni per:
 * - Inserire un centro sportivo.
 * - Modificare un centro sportivo.
 * - Visualizzare le prenotazioni.
 * - Tornare indietro al login.
 */
public class CreateGestorePanel extends JPanel {
     ...
     *
     * @param cardLayout Gestore del layout a schede (CardLayout) per la navigazione tra pannelli.
