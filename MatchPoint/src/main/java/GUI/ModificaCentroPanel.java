...
public class ModificaCentroPanel extends JPanel {
    ...
    public ModificaCentroPanel() {
        ...
        salvaButton = BackgroundPanel.createFlatButton("Salva Modifiche", e -> salvaModifiche(), new Dimension(200, 50));
        gbc.gridx = 0;
        gbc.gridy = 5;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.EAST;
        ...
        modificaCampiButton = BackgroundPanel.createFlatButton("Modifica Campi", e -> modificaCampi(), new Dimension(200, 50));
        gbc.gridx = 0;
        gbc.gridy = 4;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.EAST;
