...
/**
 * Classe principale per l'avvio dell'interfaccia grafica dell'applicazione MatchPoint.
 * Contiene i metodi per creare e gestire i principali pannelli, come login e registrazione.
 */
public class HomePage {
    ...
    /**
     * Inizializza la finestra principale e i componenti grafici.
     * Imposta l'icona dell'applicazione e il pannello di sfondo.
     */
    public void initialize() {
        ...
        BackgroundPanel backgroundPanel = new BackgroundPanel(
            "/GUI/immagini/sfondohomesfocato.png",
     ...
     * Al momento contiene solo la struttura base.
     ...
     * Include i campi per il nome, cognome, data di nascita, username e password,
     * con controlli per i campi vuoti.
     * 
